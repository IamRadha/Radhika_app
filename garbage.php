                ...
                <ul>
                    ...
                    <li class="list">
                        <div class="appliance-item">
                            <img class="icon" src="organic.png" alt="organic_icon">
                        </div>
                    ...
                    <li class="list">
                        <div class="appliance-item">
                            <img class="icon" src="inorganic.png" alt="inorganic_icon">
                        </div>
                    ...
                    <li class="list">
                        <div class="appliance-item">
                            <img class="icon" src="ewaste.png" alt="ewaste_icon">
                        </div>
...
<script>
    ...
    function calculate(inputValue, resultFieldId) {
            ...
            if (resultFieldId === 'result1') {
                result = (parsedValue * 1.9).toFixed(2);  //organic waste
            } else if (resultFieldId === 'result2') {
                result = (parsedValue * 2.5).toFixed(2);  //indorganic
            }else if (resultFieldId === 'result3') {
                result = (parsedValue * 3).toFixed(2);  //e waste
            }else if (resultFieldId === 'result4') {
                result = (parsedValue *  1.6).toFixed(2);  //Agricultural waste
            }else{
                 result = ""
